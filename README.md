# Code Particles `.github`

This repository provides the public profile for the Code Particles GitHub organization and holds shared community docs.

## What’s here

* `profile/README.md` — the organization profile shown on GitHub
* `CONTRIBUTING.md` — how to propose changes across org projects
